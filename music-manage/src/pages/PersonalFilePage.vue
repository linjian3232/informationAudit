            ...
            <el-table-column label="资源更新" align="center" width="180">
                <template slot-scope="scope">
                    <el-upload :action="uploadPublicFileUrl(scope.row.id)" :before-upload="beforePublicFileUpload" 
                        ...
                        <el-button  class="update_button" size="mini">更新发布文件</el-button>
                    </el-upload>
                </template>
            </el-table-column>
...
import {publicFileOfUploaderId,updatePublicFile,delPublicFile,download,updatePublicFileStatus} from '../api/index';
...
export default {
    ...
    methods:{
        ...
        getData(){
            this.tempData = [];
            this.tableData = [];
            publicFileOfUploaderId(this.uploaderId).then(res => {
                this.tempData = res;
                this.tableData = res;
                this.currentPage = 1;
            })
